                            ...
                            child: Row(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'CALENDAR_arrow_back_rounded_ICN_ON_TAP');
                                    logFirebaseEvent(
                      ...
                      Expanded(
                        child: wrapWithModel(
                          ...
                          child: CalendarCompWidget(
                            ...
                            onSelctedDateAction: (selectedDate) async {
                              logFirebaseEvent(
                                  'CALENDAR_Container_9s4cxvq2_CALLBACK');
                              logFirebaseEvent(
                                  'CalendarComp_update_page_state');
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Text(
                            dateTimeFormat(
                                "EEEE, MMMM d, yyyy", _model.selectedDate),
                            style: FlutterFlowTheme.of(context)
                                .titleSmall
                                .override(
                                  font: GoogleFonts.interTight(
                        ...
                        if (_model.calendarCompModel.selectedDate != null)
                          wrapWithModel(
                            model: _model.dailyEventsListModel,
                            updateCallback: () => safeSetState(() {}),
                            child: DailyEventsListWidget(
