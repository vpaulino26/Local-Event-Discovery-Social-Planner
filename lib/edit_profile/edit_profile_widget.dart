                        ...
                        children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EDIT_PROFILE_PAGE_Stack_uhdcoatq_ON_TAP');
                                    logFirebaseEvent(
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() => _model
                                              .isDataUploading_profilePhotoEdit =
                                          true);
                                      ...
                                      try {
                                        ...
                                        _model.isDataUploading_profilePhotoEdit =
                                            false;
                                      }
                                      if (selectedUploadedFiles.length ==
                                          ...
                                          downloadUrls.length ==
                                              selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFile_profilePhotoEdit =
                                              selectedUploadedFiles.first;
                                          _model.uploadedFileUrl_profilePhotoEdit =
                                              downloadUrls.first;
                                        });
                                      } else {
                                        safeSetState(() {});
                                    ...
                                    await currentUserReference!
                                      ...
                                      photoUrl: _model
                                          .uploadedFileUrl_profilePhotoEdit,
                                    ));
                                  },
                                  child: Stack(
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'EDIT_PROFILE_PAGE_dateOfBirth_ON_TAP');
                                logFirebaseEvent(
                                    'dateOfBirth_date_time_picker');
                            ...
                            child: StreamBuilder<List<UsernamesRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<UsernamesRecord>
                                    buttonUsernamesRecordList = snapshot.data!;
