...
class _ProfileSettingsWidgetState extends State<ProfileSettingsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'profile_settings'});
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'PROFILE_SETTINGS_contentView_1_ON_TAP');
                              logFirebaseEvent('contentView_1_navigate_to');

                              context.pushNamed(EditLocationWidget.routeName);
                            },
                            child: Container(
                              width: double.infinity,
                              height: 60.0,
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              await launchURL(
                                  'https://forms.gle/RPaE1MDTAxxGsjG1A');
                            },
                            child: Container(
                              width: double.infinity,
                              height: 60.0,
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              logFirebaseEvent('contentView_1_launch_u_r_l');
                              await launchURL(
                                  'https://github.com/vpaulino26/Local-Event-Discovery-Social-Planner/blob/main/docs/privacy%20policy.pdf');
                            },
                            child: Container(
                              width: double.infinity,
                              height: 60.0,
