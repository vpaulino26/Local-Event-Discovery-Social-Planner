    ...
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: CreateProfile3Widget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => EventDetailsWidget(
            ...
            formattedDate: params.getParam(
              'formattedDate',
              ParamType.String,
            ),
            formattedTime: params.getParam(
              'formattedTime',
              ParamType.String,
            ),
            ...
            priceRange: params.getParam(
              'priceRange',
              ParamType.String,
            ),
            ticketUrl: params.getParam(
              'ticketUrl',
              ParamType.String,
            ),
            ...
            categorySegment: params.getParam(
              'categorySegment',
              ParamType.String,
            ),
            categoryGenre: params.getParam(
              'categoryGenre',
              ParamType.String,
            ),
            categorySubGenre: params.getParam(
              'categorySubGenre',
              ParamType.String,
            ),
            ...
            saleStart: params.getParam(
              'saleStart',
              ParamType.String,
            ),
            saleEnd: params.getParam(
              'saleEnd',
              ParamType.String,
            ),
            venueAddressLine1: params.getParam(
              'venueAddressLine1',
              ParamType.String,
            ),
            parkingDetail: params.getParam(
              'parkingDetail',
              ParamType.String,
            ),
            accessibilityInfo: params.getParam(
              'accessibilityInfo',
              ParamType.String,
            ),
            ...
            seatmapUrl: params.getParam(
              'seatmapUrl',
              ParamType.String,
            ),
            homepageUrl: params.getParam(
              'homepageUrl',
              ParamType.String,
            ),
