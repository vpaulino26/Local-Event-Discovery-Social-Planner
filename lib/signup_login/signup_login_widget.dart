              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Opacity(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 15.0, 0.0, 115.0),
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(22.0),
                        child: Image.asset(
                          'assets/images/230734162.png',
                          width: 300.0,
                          height: 118.7,
                          fit: BoxFit.cover,
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: TabBar(
                                      ...
                                      indicatorColor: Color(0x8F0E055C),
                                      indicatorWeight: 3.0,
                                      tabs: [
                                        Tab(
                                          text: 'Create Account',
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    5.0),
                                                        child: Text(
                                                          'Tip: Calendar only available with Google sign-in.',
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'SIGNUP_LOGIN_FORGOT_PASSWORD_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_auth');
                                                          if (_model
                                                              .emailAddressTextController
